...
public class AllEssentialPlatformTests {
	...
	public static Test suite() {
		...
		suite.addTest(org.essentialplatform.runtime.shared.tests.AllRuntimeTests.suite()); // specific to runtime
		suite.addTest(org.essentialplatform.runtime.shared.tests.remoting.AllRemotingTests.suite()); 
