...
public class AboutNakedObjects {
    ...
    public static String getVersion() {
        return select("Version 2", "Version 2");
    }
    
    public static String getImageName() {
        return select("small-logo.jpg", "logo.jpg");
    }
    ...
    public static String getName() {
        return select("Naked Object Framework", "Naked Objects Framework");
    }
    
    public static String getBuildId() {
        return select("pojo-20050316-1300", "(temporary build)");
    }
    
    
    public static String getCopyrightNotice() {
        return select("Copyright  © 2000 - 2005 Naked Objects Group Ltd", "Copyright Naked Objects Group");
    }
