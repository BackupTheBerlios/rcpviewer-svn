 ...
 *
 */
public class ConfigElementSorter implements Comparator<IConfigurationElement> {
	...
	public int compare(IConfigurationElement ice1, IConfigurationElement ice2) {
        ...
        String bundleId1 = ice1.getDeclaringExtension().getNamespace();
        String bundleId2 = ice2.getDeclaringExtension().getNamespace();
    ...
    private Bundle[] getRequisiteBundles( Bundle bundle )
        ...
        Bundle[] requisites = BUNDLE_REQUISITES.get( bundle );
        if ( requisites == null ) {
            ...
            if ( requires == null ) {
				...
				requisites = requiredBundles.toArray( EMPTY_BUNDLE_ARRAY );
            }
