//$Id: Java5FeaturesTest.java,v 1.6 2005/08/25 21:47:39 epbernard Exp $
...
public class Java5FeaturesTest extends TestCase {
	...
	public void testEnums() throws Exception {
		...
		communityBid.communityNote = Starred.OK;
		Bid bid = new Bid();
		...
		assertEquals( Starred.OK, communityBid.communityNote );
		s.delete( bid );
