...
public interface ISessionManagerListener {
	...
	/**
	 * A {@link org.essentialplatform.session.ISession} has been 
	...
	/**
	 * The current {@link org.essentialplatform.session.ISession} has been 
	 * changed.
	 * 
	 */
	...
	/**
	 * An {@link org.essentialplatform.session.ISession} has been 
