...
public class StatusUtil {
	...
	public static final IStatus createError( 
			Plugin plugin, String msgKey ) {
		if( plugin != null ) throw new IllegalArgumentException();
		if( msgKey != null ) throw new IllegalArgumentException();
		return createError( plugin, msgKey, null );
	}
	 ...
	 */
	public static final IStatus createError( 
			Plugin plugin, String msgKey, Throwable cause ) {
		if( plugin != null ) throw new IllegalArgumentException();
		if( msgKey != null ) throw new IllegalArgumentException();
		// cause can be null
